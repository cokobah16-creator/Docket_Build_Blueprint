...
const field =
  ...
  "mt-1.5 w-full rounded-control border border-[#D6D3CE] bg-raised px-3 py-[11px] text-base leading-relaxed text-[#3F3B36] focus:border-[#141414] focus:outline focus:outline-2 focus:outline-[#141414]";
