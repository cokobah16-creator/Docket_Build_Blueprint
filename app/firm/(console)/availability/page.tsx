      ...
      {isAdmin && staff.length > 1 ? (
        <Card>
          <form method="get" action="/firm/availability" className="grid gap-3 px-5 py-4 sm:grid-cols-[1fr_auto] sm:items-end">
            ...
            <div>
              <label htmlFor="lawyer" className="text-sm font-medium text-ink">Whose week</label>
      ...
      <Card>
        ...
        {!service ? (
          ...
          <CardBody className="space-y-4 p-0">
            ...
            <div className="space-y-1 border-t border-hairline px-5 py-4 text-xs text-ink-muted">
              <p>
