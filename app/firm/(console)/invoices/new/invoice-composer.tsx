    ...
    <form onSubmit={(e) => submit(e, false)} className="space-y-5">
      ...
      <Card>
        ...
        <CardBody className="space-y-4">
          <div>
            <label htmlFor="client_filter" className="text-sm font-medium text-ink">
              Find the client
            </label>
          ...
          <div>
            <label htmlFor="matter" className="text-sm font-medium text-ink">
              Against a matter
            </label>
            <p className="text-xs text-ink-muted">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <p className="text-xs text-ink-muted">The firm bills in {defaultCurrency} unless you say otherwise.</p>
              <select
                id="currency"
                value={currency}
            ...
            <div>
              <label htmlFor="due_on" className="text-sm font-medium text-ink">
                Falls due on
              </label>
              <p className="text-xs text-ink-muted">Optional. After this day the invoice reads as overdue.</p>
        ...
        <CardBody className="space-y-4">
          {lines.map((line, index) => {
            ...
            return (
              <div key={line.key} className="rounded-lg border border-hairline p-3">
                <div>
                  <label htmlFor={`description_${line.key}`} className="text-sm font-medium text-ink">
                    Line {index + 1}
                  </label>
                  <input
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                  <div>
                    <label htmlFor={`quantity_${line.key}`} className="text-sm font-medium text-ink">
                      Quantity
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor={`unit_${line.key}`} className="text-sm font-medium text-ink">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {lines.length >= MAX_ITEMS && (
              <p className="text-xs text-ink-muted">An invoice takes at most {MAX_ITEMS} lines.</p>
            )}
          </div>
        </CardBody>
      </Card>
