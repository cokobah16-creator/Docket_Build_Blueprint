      ...
      <Screen>
        ...
        {notes && notes.client_summary && (
          <Card>
            ...
            <CardBody className="space-y-3 text-[13.5px] leading-relaxed text-ink">
              <p className="whitespace-pre-wrap">{notes.client_summary}</p>
              {notes.advice_given && (
                <div><p className="text-[11px] uppercase tracking-wide text-ink-muted">Advice</p><p className="whitespace-pre-wrap">{notes.advice_given}</p></div>
              )}
              {notes.follow_up && (
                <div><p className="text-[11px] uppercase tracking-wide text-ink-muted">Next steps</p><p className="whitespace-pre-wrap">{notes.follow_up}</p></div>
              )}
