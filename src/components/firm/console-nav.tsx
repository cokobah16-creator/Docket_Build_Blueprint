...
const BEHIND_ME = ["/firm/me", "/firm/search", "/firm/sittings", "/firm/matters", "/firm/messages", "/firm/tasks", "/firm/uploads", "/firm/inbox", "/firm/invoices", "/firm/availability", "/firm/overview", "/firm/security", "/firm/admin"];
