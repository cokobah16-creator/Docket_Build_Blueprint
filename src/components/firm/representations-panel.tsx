      ...
      {issued && (
        <CardBody>
          <Alert kind="success" title="Authority recorded — now send the link">
            ...
            <code className="mt-2 block break-all rounded-lg bg-raised px-2 py-1.5 font-mono text-11 text-ink">
        ...
        <CardBody className="border-t border-hairline">
          <form onSubmit={grant} className="space-y-3">
            <div className="grid gap-3 sm:grid-cols-2">
              <label className="block text-15 text-ink">In what capacity
                ...
                <span className="mt-1 block text-13 text-ink-muted">{CAPACITIES.find((c) => c.value === form.capacity)?.hint}</span>
              </label>
              <label className="block text-15 text-ink">Acting for which body (optional)
            ...
            <label className="block text-15 text-ink">Over what
            ...
            <fieldset className="rounded-lg border border-hairline p-3">
              <legend className="px-1 text-15 font-medium text-ink">What they may do</legend>
              ...
              <label className="mt-2 flex items-center gap-2 text-15 text-ink">
              ...
              <label className="mt-1 flex items-center gap-2 text-15 text-ink">
            ...
            <fieldset className="rounded-lg border border-hairline p-3">
              <legend className="px-1 text-15 font-medium text-ink">What you saw</legend>
              <p className="text-13 text-ink-muted">
              ...
              <div className="mt-2 grid gap-3 sm:grid-cols-2">
                <label className="block text-15 text-ink">Kind
                ...
                <label className="block text-15 text-ink">Its reference
              ...
              <label className="mt-2 block text-15 text-ink">Note
