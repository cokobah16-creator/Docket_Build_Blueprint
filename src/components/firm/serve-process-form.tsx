...
export function ServeProcessForm({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor={id("doc")} className="text-sm font-medium text-ink">
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-ink-muted">As it reads on the face of the process.</p>
      </div>

      <div>
        <label htmlFor={id("method")} className="text-sm font-medium text-ink">How was it served?</label>
      ...
      {isPlatform ? (
        ...
        <div className="flex flex-wrap items-end gap-3">
          <div className="min-w-[9rem] flex-1">
            <label htmlFor={id("day")} className="text-sm font-medium text-ink">Date served</label>
            <input
          ...
          <div className="w-28">
            <label htmlFor={id("time")} className="text-sm font-medium text-ink">Time</label>
      ...
      <div className="space-y-2 rounded-lg border border-hairline p-3">
        <label className="flex min-h-[44px] items-start gap-2 text-sm font-medium text-ink">
          <input
        ...
        {substituted && (
          <div>
            <label htmlFor={id("order")} className="text-sm font-medium text-ink">
      ...
      <fieldset className="space-y-3 rounded-lg border border-hairline p-3">
        <legend className="px-1 text-sm font-medium text-ink">Who was served</legend>
        <div className="grid gap-3 sm:grid-cols-2">
          <div>
            <label htmlFor={id("on")} className="text-sm font-medium text-ink">Served on</label>
            <input
          ...
          <div>
            <label htmlFor={id("capacity")} className="text-sm font-medium text-ink">In what capacity</label>
            <input
        ...
        <div>
          <label htmlFor={id("address")} className="text-sm font-medium text-ink">Address where served</label>
          <textarea
        ...
        <div>
          <label htmlFor={id("server")} className="text-sm font-medium text-ink">Who served it</label>
          <input
      ...
      <div className="space-y-2 rounded-lg border border-hairline p-3">
        ...
        <div>
          <label htmlFor={id("deemed")} className="text-sm font-medium text-ink">Deemed served on</label>
          <input
