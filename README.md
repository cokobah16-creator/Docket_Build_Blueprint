...
**Validated:** all forty-eight migrations, the seed and thirty SQL suites (1,262 checks) run clean on PostgreSQL 16. The onboarding runbook is `docs/ONBOARDING_A_FIRM.md`; every server function is catalogued in `docs/RPC_REFERENCE.md`.
