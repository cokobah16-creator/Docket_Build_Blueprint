...
**Validated:** all thirty-one migrations, the seed and fifteen SQL suites (526 checks) run clean on PostgreSQL 16. The onboarding runbook is `docs/ONBOARDING_A_FIRM.md`; every server function is catalogued in `docs/RPC_REFERENCE.md`.
