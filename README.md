...
**Validated:** all forty-seven migrations, the seed and twenty-nine SQL suites (1,211 checks) run clean on PostgreSQL 16. The onboarding runbook is `docs/ONBOARDING_A_FIRM.md`; every server function is catalogued in `docs/RPC_REFERENCE.md`.
