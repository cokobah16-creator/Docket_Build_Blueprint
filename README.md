...
**Validated:** all thirty-eight migrations, the seed and twenty-one SQL suites (798 checks) run clean on PostgreSQL 16. The onboarding runbook is `docs/ONBOARDING_A_FIRM.md`; every server function is catalogued in `docs/RPC_REFERENCE.md`.
