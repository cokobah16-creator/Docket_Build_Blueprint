...
**Validated:** all 53 migrations, the seed and 32 SQL suites (1,424 checks) are checked on PostgreSQL 16. The onboarding runbook is `docs/ONBOARDING_A_FIRM.md`; every server function is catalogued in `docs/RPC_REFERENCE.md`.
